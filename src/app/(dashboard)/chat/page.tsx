...
const TOPIC_GROUPS = [
  {
    ...
    questions: [
      "كيف كان الأداء هذا الشهر؟",
      "ما هي المنصة الأفضل أداءً؟",
      "قارن أداء المنصات الثلاث",
    ],
  },
  {
    icon: TrendingUp,
    label: "النمو والاتجاهات",
    color: "text-emerald-600 bg-emerald-50",
    questions: [
      "ما هي اتجاهات النمو؟",
      "كيف تطور عدد المتابعين؟",
      "ما هو أسرع المنصات نمواً؟",
    ],
  },
  {
    icon: Eye,
    label: "المشاهدات والوصول",
    color: "text-blue-600 bg-blue-50",
    questions: [
      "كم مشاهدة حصلنا عليها؟",
      "أي المنصات أعلى وصولاً؟",
      "كيف نزيد المشاهدات؟",
    ],
  },
  {
    ...
    questions: [
      "ما هو معدل التفاعل لكل منصة؟",
      "ما هي أنواع المحتوى الأعلى تفاعلاً؟",
      "كيف نحسن معدل التفاعل؟",
    ],
  },
  {
    icon: Users,
  ...
  },
  {
    ...
    questions: [
      "ما هي أفكار محتوى مقترحة؟",
      "ما هو أفضل نوع محتوى لبيتونيا؟",
      "ما هي الهاشتاقات الأفضل؟",
    ],
  },
  {
    icon: MessageSquare,
    ...
    questions: [
      "ما هي توصياتك لتحسين الأداء؟",
      "ما هي أولويات العمل القادمة؟",
      "كيف نبني استراتيجية محتوى؟",
    ],
  },
];
        ...
        <aside className="w-64 shrink-0 overflow-y-auto space-y-3">
          <div className="bg-white rounded-2xl border border-slate-100 p-4 shadow-sm">
            ...
            <p className="text-slate-400 text-xs leading-relaxed">
              اسأل عن أداء السوشيال ميديا وستحصل على تحليل مبني على بياناتك الفعلية.
            </p>
          </div>
              ...
              <div className="px-3 pb-3 space-y-1 border-t border-slate-100">
                {questions.map((q) => (
                  ...
                  <button
                    ...
                    onClick={() => {
                      // Find the chat input and set the value, then click send
